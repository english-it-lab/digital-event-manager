...
class Topic(BaseModel):
    ...
    section_id: Annotated[int, Field(strict=True, ge=1)]
    name: Annotated[str, Field(min_length=3, strict=True, max_length=50)]
    __properties: ClassVar[List[str]] = ["id", "section_id", "name"]
