...
class TopicUpdate(BaseModel):
    """
    Данные для обновления темы. Можно менять название и/или секцию.
    """ # noqa: E501
    name: Optional[Annotated[str, Field(min_length=3, strict=True, max_length=50)]] = None
    section_id: Optional[Annotated[int, Field(strict=True, ge=1)]] = None
    __properties: ClassVar[List[str]] = ["name", "section_id"]
    ...
    def from_json(cls, json_str: str) -> Self:
        """Create an instance of TopicUpdate from a JSON string"""
    ...
    def from_dict(cls, obj: Dict) -> Self:
        """Create an instance of TopicUpdate from a dict"""
        if obj is None:
            return None
